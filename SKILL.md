...
metadata: {"author":"MissiaL","version":"0.3.0","keywords":["wildberries","wb","вайлдберриз","вб","seller-api","marketplace","product-cards","prices","orders","analytics","promotions","reports","finance","rate-limits"]}
---
...
```bash
python scripts/api_call.py --method GET --url "https://common-api.wildberries.ru/api/v1/seller-info" --show-rate-limit
```
